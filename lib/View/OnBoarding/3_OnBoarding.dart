  ...
  Widget build(BuildContext context) {
    return Material(
      child: Scaffold(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                  ...
                  color: Colors.black,
                  child: Image.asset(ImageConstrants.ONBOARD3,fit: BoxFit.cover,)
              ),
              SizedBox(height: 20,),
              Align(
        ...
        bottomSheet: InkWell(
          onTap: (){
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (c)=>LoginSelection()), (route) => false);
          },
          child: Container(
            width: MediaQuery.of(context).size.width,
            height: 60,
